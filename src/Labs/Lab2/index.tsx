...
export default function Lab2() {
    ...
    <Container>
        ...
        <h3>Styling with the STYLE attribute</h3>
            ...
            right on the element. <span className="wd-class-selector">Although it's very convenient
            it is considered bad practice and you should avoid
            using the style attribute</span>
            </p>
            <p id="wd-id-selector-1">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati dolores ad laudantium magnam totam omnis quam numquam rem atque ab optio, distinctio itaque odit nulla pariatur vitae excepturi harum nobis?
            </p>
            <p id="wd-id-selector-2" className="wd-border-solid">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati dolores ad laudantium magnam totam omnis quam numquam rem atque ab optio, distinctio itaque odit nulla pariatur vitae excepturi harum nobis?
            </p>
            <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati dolores ad laudantium magnam totam omnis quam numquam rem atque ab optio, distinctio itaque odit nulla pariatur vitae excepturi harum nobis?
        ...
        <div id="wd-css-borders">
            ...
            <p className="wd-rounded-corners-bottom wd-border-thin
                wd-border-blue wd-border-solid wd-padding-fat">
                Rounded corners at the bottom </p>
            <p className="wd-rounded-corners-all-around wd-border-thin
                wd-border-blue wd-border-solid wd-padding-fat">
                Rounded corners all around </p>
            <p className="wd-rounded-corners-inline wd-border-thin
                wd-border-blue wd-border-solid wd-padding-fat">
