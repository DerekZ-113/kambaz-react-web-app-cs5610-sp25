...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <h4>Update Title</h4>
      <a id="wd-update-todo-title" href={`${API}/${todo.id}/title/${todo.title}`} className="btn btn-primary float-end">
        Update Title
      </a>
      ...
      <a id="wd-update-todo-description" href={`${API}/${todo.id}/description/${todo.description}`} className="btn btn-info float-end">
        Update Description
      </a>
      <FormControl defaultValue={todo.id} className="w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
      ...
      <a id="wd-update-todo-completed" href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-warning float-end">
